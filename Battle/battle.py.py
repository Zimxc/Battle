...
class Fighter():
	...
	def attack(self, target):
		...
		rand_crit = random.randint(1,10)
		if rand_crit == 1:
			rand_crit = 15
		else:
			rand_crit = 0
		rand = random.randint(0, 0)
		damage = self.strength + rand + rand_crit
		target.hp -= damage
...
knight = Fighter(200, 260, 'Knight',60, 20, 3)
bandit1 = Fighter(550, 270, 'Bandit', 40, 10, 1)
bandit2 = Fighter(700, 270, 'Bandit', 40, 10, 1)
